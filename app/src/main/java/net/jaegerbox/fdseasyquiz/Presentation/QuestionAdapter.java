package net.jaegerbox.fdseasyquiz.Presentation;
...
import net.jaegerbox.fdseasyquiz.R;
 ...
 *
 * If you don't like our puns, we named this Adapter QuestionAdapter because its
 * contents are green.
 */
public class QuestionAdapter extends RecyclerView.Adapter<QuestionAdapter.QuestionViewHolder> {
    ...
    /**
     * Constructor for QuestionAdapter that accepts a number of items to display and the specification
     * for the ListItemClickListener.
     *
     * @param numberOfItems Number of items to display in list
     * @param listener Listener for list item clicks
     */
    public QuestionAdapter(int numberOfItems, ListItemClickListener listener) {
    ...
    @Override
    public int getItemViewType(int position) { //TODO: implementare logica del se tabella usa layout tabella
        return 1;
    ...
    class QuestionViewHolder extends RecyclerView.ViewHolder
         ...
         *                 {@link QuestionAdapter#onCreateViewHolder(ViewGroup, int)}
         */
